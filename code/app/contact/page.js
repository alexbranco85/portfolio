...
const Home = () => {
  ...
  return (
    <Grid container sx={{ backgroundImage: 'url("bg-home.png")', backgroundPosition: 'center', backgroundSize: 'cover', height: 'calc(100vh - 37.5px)', px: { xs: 5, sm: 20 }, alignItems: 'center' }}>
